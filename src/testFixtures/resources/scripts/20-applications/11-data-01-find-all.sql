...
--;
insert into app_resources (id, name, application_id, created_by, last_modified_by, version_no)
values ('menu.home', 'Menu Home', 'frontend-app', 'admin', 'admin', 1)
;
insert into app_resources (id, name, application_id, created_by, last_modified_by, version_no)
values ('menu.items', 'Menu Items', 'frontend-app', 'admin', 'admin', 1)
;
insert into app_resources (id, name, application_id, created_by, last_modified_by, version_no)
values ('menu.shops', 'Menu Shops', 'frontend-app', 'admin', 'admin', 1)
;
insert into app_resources (id, name, application_id, created_by, last_modified_by, version_no)
values ('menu.merchants', 'Menu Merchants', 'frontend-app', 'admin', 'admin', 1)
;
insert into app_resources (id, name, application_id, created_by, last_modified_by, version_no)
values ('menu.i18n', 'Menu i18n', 'frontend-app', 'admin', 'admin', 1)
;
insert into app_resources (id, name, application_id, created_by, last_modified_by, version_no)
values ('menu.lang', 'Menu Lang', 'frontend-app', 'admin', 'admin', 1)
;
